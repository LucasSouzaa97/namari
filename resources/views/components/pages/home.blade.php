<x-app-layouts>
    <div id="wrapper">
        ...
        <main id="content">
            ...
            <aside
                id="gallery"
                class="row scrollto clearfix text-center"
            ...
            >
                ...
                <div class="row no-padding-bottom clearfix">
                    ...
                    <div class="col-3">
                        <!--User Testimonial-->
                        <blockquote class="testimonial bigtest text-right">
            ...
            <section
                id="pricing"
                class="secondary-color scrollto clearfix text-center"
            >
                <div class="row clearfix">
